(function(){
     ...
     * Creating List controller and attaching it to the main dogFacts module
    ...
    function ListController(quizMetrics, DataService){
        ...
        vm.data = DataService.dogsData; // Controller reference to the dog info created in the factory

        vm.activedog = {}; // will be used in the view to hold the data of currently active dog

        vm.changeActivedog = changeActivedog; // reference to a named function below
        ...
        function changeActivedog(index){
            ...
            // simple function to attach the data of the dog clicked on to 

            // the active dog object
